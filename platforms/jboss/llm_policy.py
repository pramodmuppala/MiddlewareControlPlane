#!/usr/bin/env python3
"""
OpenAI-backed scaling policy module for jboss_autoscaler.py.
...
You receive a JSON snapshot for a JBoss EAP multi-instance deployment.
...
def _make_user_prompt(snapshot: Dict[str, Any]) -> str:
    return (
        "Evaluate this JBoss scaling snapshot and recommend one action.\n\n"
...
def get_llm_recommendation(
    ...
    *,
    ...
    chosen_model = model or os.getenv("OPENAI_MODEL", "gpt-4o-2024-08-06")
